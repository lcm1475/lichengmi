...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>上传或者拖拽文件</b></span>",
            uploadStr:"上传",
            abortStr: "停止上传",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Done",
            multiDragErrorStr: "多文件拖放是不允许的",
            extErrorStr: "后缀不允许，允许的扩展：",
            duplicateErrorStr: "文件已经存在",
            sizeErrorStr: "文件的最大尺寸：",
            uploadErrorStr: "上传不允许",
            maxFileCountErrorStr: "最大的文件数量为:",
            downloadStr: "下载",
